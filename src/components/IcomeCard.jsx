    ...
    <div className="flex flex-col gap-4">
      <div className="flex gap-4">
        <div className="flex flex-col">
            <label  className="text-[hsl(0,100%,100%)]" htmlFor="icome-description">Income Description</label>
            <input className="border border-[hsl(0,100%,100%)] rounded-md py-1" type="text" id="icome-description" />
        </div>
        <div className="flex flex-col">
            <label className="text-[hsl(0,100%,100%)] rounded-md" htmlFor="amount">Amount</label>
